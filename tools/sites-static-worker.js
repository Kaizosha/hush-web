...
const DEFAULT_PRODUCT_SLOT = "bottom-left";
...
function applyProductSlot(html, requestedSlot) {
  ...
  return html
    ...
    .replace(
      `class="product-cell is-active" data-product-slot="${DEFAULT_PRODUCT_SLOT}"`,
      `class="product-cell is-active" data-product-slot="${requestedSlot}"`,
    )
    .replace(
      `class="product-cell" data-product-slot="${requestedSlot}"`,
      `class="product-cell" data-product-slot="${DEFAULT_PRODUCT_SLOT}"`,
    );
}
